<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asus.aspx.cs" Inherits="btl.laptop.Asus" %>
...
<body>
    ...
    <div class="up">
        <div class="abc">
            <a href="WebForm1.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Asus.aspx"><strong>Máy Asus</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="danhsachAsus" runat="server">
                    <ItemTemplate>
