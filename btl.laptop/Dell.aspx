<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dell.aspx.cs" Inherits="btl.laptop.Dell" %>
...
<body>
    ...
    <div class="up">
        <div class="abc">
            <a href="WebForm1.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Dell.aspx"><strong>Máy Dell</strong></a>
        </div>
    </div>
    <div class="container">
            ...
            <div class="row_1">
                ...
                <div class="show">
                    <ul>
						...
						<li><a href="Asus.aspx">Máy MacBook</a></li>
						<li><a href="Asus.aspx">Máy Lenovo</a></li>
                    </ul>
                </div>
            </div>
			<div class="row_2"></div>
