<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Macbook.aspx.cs" Inherits="btl.laptop.Macbook" %>
...
<body>
    ...
    <div class="up">
        <div class="abc">
            <a href="WebForm1.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Macbook.aspx"><strong>Macbook</strong></a>
        </div>
    </div>
    <div class="container">
